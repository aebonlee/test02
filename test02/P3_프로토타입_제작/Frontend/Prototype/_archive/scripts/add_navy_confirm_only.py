...
# Work on backup2 file ONLY, DO NOT touch color variables
with open('prototype_index_최종개선_백업2.html', 'r', encoding='utf-8') as f:
    content = f.read()

# Add custom confirm dialog before </body>
# Confirm button uses Navy (#2C4A8A = var(--tertiary))
custom_dialog = '''
...
print("Done! Added Navy confirm button to backup2 file")
print("NO color variables changed!")
